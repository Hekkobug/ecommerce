...
export {default as SellectOption} from './SellectOption'
export {default as DealDaily} from './DealDaily'
export {default as Countdown} from './Countdown'
export {default as FutureProducts} from './FutureProducts'
export {default as ProductCard} from './ProductCard'
export {default as CustomSliders} from './CustomSliders'
